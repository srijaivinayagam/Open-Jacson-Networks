...
## Output
<img width="841" height="527" alt="Screenshot 2026-08-25 152911" src="https://github.com/user-attachments/assets/7d3d9912-79a2-4ab5-a3a1-1a2bc38cf740" />


## Result

The Open Jackson Network series queuing system was successfully simulated for materials processed through multiple lathe machines and a robot. The system's performance metrics—including the average number of materials and their waiting times in the overall system and each individual conveyor—were successfully determined.
